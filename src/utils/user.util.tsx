...
export const setAdminInfo = async (info:any) => {
  const _data = { ...info };
...
export const setWorkshopInfo = async (info:any) => {
  const _data = { ...info };
...
export const setVendorInfo = async (info:any) => {
  const _data = { ...info };
...
export const setUserRole = async (info:any) => {
  const _data = { ...info };
...
export const getCategories = async () => {
  ...
  const categories = filter(_userInfo.categories, (item:any) => item._id);

...
export default function CompareCompetitor() {
  ...
  return (
    <div className="compare-competitor-section">
      <div className="compare-competitor-heading">
      ...
      <div className="compare-competitor-body-alignment">
        <div className="compare-competitor-box-alignment">
          <div className="compare-competitor-flex-alignment">
            <div className="compare-competitor-input">
                ...
                {Dropdown1 && (
                  <div className="search-box-drodown-alignment">
                    ...
                    <div className="search-option-select-alignment">
                      <ul>
                        <li className="active-link">All</li>
                      </ul>
                    </div>
                  </div>
                )}

...
import "../../../routes/CustomsEasy/EffortlessCustoms/EffortlessCustoms.scss";
...
function CommonDropdown({
  ...
  return (
    <>
      <div>
        <div className="effortess-customs-input-alignment">
          <label>{label}</label>
          <div className="effortess-customs-inout-dropdown" ref={dropdownRef}>
            <div
              className={`effortess-customs-input-box ${
                isOpen ? "active" : ""
              }`}
            ...
            >
              ...
              <div
                className={`effortess-customs-dropdown-box-alignment ${
                  isOpen
                ...
                {isNoDataFound ? (
                  ...
                  filteredOptions?.map((option, index) => (
                    <div className="effortess-dropdoewn-name" key={index}>
                      <p onClick={() => handleOptionSelect(option?.value)}>

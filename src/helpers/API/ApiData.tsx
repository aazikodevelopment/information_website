...
export const ApiPutNoAuth = (type:any, userData:any) => {
...
export const ApiPost = (type:any="", userData:any=[], AdditionalHeader:any=[]) => {
    return new Promise((resolve, reject) => {
...
export const ApiPostStaticToken = (type:any="", userData:any=[], AdditionalHeader:any=[]) => {
    return new Promise((resolve, reject) => {
        // console.log("dataBody", userData);
        axios
            .post(BaseURL + type, userData, {
                ...getHttpOptionsStatic(),
                ...AdditionalHeader,
            })
            .then((responseJson:any) => {
                // console.log("responseJson",responseJson);
...
export const ApiDelete = (type:any='', userData:any=[]) => {
    return new Promise((resolve, reject) => {
        axios({
            url: BaseURL + type,
            method: "delete",
...
export const getHttpOptionsStatic = (options = defaultHeaders) => {
    let headers:any = {};
    if (options.hasOwnProperty("isAuth") && options.isAuth) {
            headers["x-auth-token"] =  "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJfaWQiOiI2MzA4NDk1NjRhOTA3YTU4MTdhM2NkNjkiLCJpYXQiOjE2NjE0ODc0ODh9.9MZ78sPf-b3Vmrg8bCOn6Kg71uvS7TOna88xSQE-KPM"
    }
